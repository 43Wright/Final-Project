...
#Adding total expenses column
spending <- spending %>% mutate(total_expenses = rowSums(pick(tuition:miscellaneous)))
spending
```
...
#expenses_df <- spending %>% select(tuition, housing, food, transportation, books_supplies, entertainment, personal_care, technology, health_wellness, miscellaneous)
#ggplot(data = expenses_df, aes())
#spending %>% ggplot(aes(x = c(tuition, health_wellness, transportation))) + geom_col()
```
...
#spending %>% ggplot(aes(x = c('transportation', 'book_supplies', 'entertainment')) + geom_point()
```
