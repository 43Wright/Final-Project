...
9) Correlations of each variable/attribute
...
```
``` {r}
## Student monthly income based on year
spending %>% group_by(year_in_school) %>% ggplot(aes(x = year_in_school, y = monthly_income, fill = year_in_school)) + geom_col()
